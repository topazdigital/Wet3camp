-- =============================================================================
-- Wet3.camp — PostgreSQL Migration (Replit dev environment only)
-- Converted from MySQL wet3camp-migration.sql for use with PostgreSQL.
-- Production uses MySQL. This file is for Replit development only.
-- =============================================================================
