...
import { Users, MapPin, ShieldCheck, Flame, Star, Video, Hotel, Plane, ShoppingBag, Calendar, Newspaper, Navigation } from 'lucide-react'
          ...
          <div className="px-3 sm:px-5 py-3 border-b border-color flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div>
              ...
              <p className="text-xs text-text-muted flex items-center gap-1">
                {geoState==='done' ? <><div className="w-1.5 h-1.5 bg-[#28a745] rounded-full animate-pulse inline-block"/>{locationLabel}</>: locationLabel}
                {' · '}1,200+ profiles
              </p>
            </div>
          </div>
