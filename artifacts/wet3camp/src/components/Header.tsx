        ...
        <div className="flex items-center gap-0.5">
          ...
          {isLoggedIn && (
            <div className="relative" ref={notifRef}>
              ...
              {notifOpen && (
                <div className="absolute right-0 top-10 w-80 max-w-[calc(100vw-1rem)] bg-card-bg border border-color rounded-xl shadow-2xl shadow-black/60 overflow-hidden z-50">
